...
enum MaterialType { DIFFUSE, MICROFACET_DIFFUSE, MICROFACET_GLOSSY,MICROFACET};
...
Vector3f Material::sample(const Vector3f &wi, const Vector3f &N){
    switch(m_type){
        case DIFFUSE: case MICROFACET_DIFFUSE: case MICROFACET_GLOSSY: case MICROFACET:
        {
...
//       fresnel(wi, N, 1.2f, F);
    ...
    {
        double m=roughness; // lager, more diffused
